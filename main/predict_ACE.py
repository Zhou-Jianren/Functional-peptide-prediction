...
def predict(feature):
    ...
    model_GRU_dir = 'ACE/save_models/GRU/Independence'
    model_CNN_dir = 'ACE/save_models/CNN/Independence'
    model_CapsuleGAN_dir = 'ACE/save_models/CapsuleGAN/Independence'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Process a FASTA file and predict ACE inhibitory peptide activity.')
    ...
    activity = assign_activity(predicted_class)
